...
# Install K3S
INSTALL_K3S_VERSION="v1.27.1+k3s1" K3S_TOKEN="surveily" K3S_URL=https://$1:6443 INSTALL_K3S_SKIP_DOWNLOAD=true INSTALL_K3S_EXEC='server --disable local-storage' ./install.sh
