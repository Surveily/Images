...
apt-get update && apt-get upgrade -y && apt-get install -y wireguard resolvconf nvme-cli nfs-common smartmontools iperf inetutils-traceroute lm-sensors net-tools software-properties-common vim
